...
def plot_loss_curves(results: Dict[str, List[float]]):
    ...
    plt.xlabel('Epochs')
    plt.legend()
    plt.savefig('/home/h6x/git_projects/ornl-overdose-modeling-per-images/SEResNet_3_channels_CIFAR/plots/loss_and_accuracy_curves_test_1_90_percentile_1.png')